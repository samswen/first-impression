...
export interface DemoPageOptions {
	...
	inviteUrl?: string; // admin invitation link URL
}
...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .collapsible-details[open] .collapsible-summary h2 {
      font-size: 30px;
      font-weight: 700;
      color: #fff;
      letter-spacing: -0.3px;
    ...
    @media (max-width: 640px) {
      ...
      .collapsible-summary h2 { font-size: 18px; }
...
<body>
  ...
  <header class="site-header">
    <div class="container header-inner">
      ...
      <a class="header-right" href="${esc(setup.website || app.homePageUrl || "#")}" target="_blank" rel="noopener">
  ...
  ${
		tagline || inventoryDescription
			? `<!-- Business Background (collapsible) -->
  <section class="section-gray">
    <div class="container-narrow">
      <details class="collapsible-details">
        <summary class="collapsible-summary">
          <h2>Business Background</h2>
          <svg class="collapsible-chevron" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"/></svg>
        </summary>
        <div class="collapsible-content">
          ${tagline ? `<h3 style="font-size:20px;font-weight:600;color:#fff;margin-bottom:12px;line-height:1.4">${esc(tagline)}</h3>` : ""}
          ${inventoryDescription ? `<p style="font-size:16px;color:rgba(255,255,255,0.6);line-height:1.8;white-space:pre-line">${esc(inventoryDescription)}</p>` : ""}
        </div>
      </details>
    </div>
  </section>`
  ...
  <!-- Introducing XInfer.AI (collapsible) -->
  <section class="section-dark">
    <div class="container-narrow">
      <details class="collapsible-details">
        <summary class="collapsible-summary">
        ...
        <div class="collapsible-content">
          <p style="font-size:16px;color:rgba(255,255,255,0.55);max-width:560px;margin:0 auto 32px;line-height:1.7">A digital employee for every customer &mdash; 24/7<br>Turns conversations into sales &mdash; automatically</p>
          <div class="intro-video-wrap">
            <iframe src="https://www.youtube-nocookie.com/embed/SCaUclbU1sE?rel=0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen referrerpolicy="origin"></iframe>
          </div>
        </div>
      </details>
    </div>
  ...
  <!-- One AI Brain, Every Channel (collapsible) -->
  <section class="section-gray">
    <div class="container">
      <details class="collapsible-details" style="max-width:none">
        <summary class="collapsible-summary">
          <h2>One AI Brain, Every Channel</h2>
          <svg class="collapsible-chevron" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"/></svg>
        </summary>
        <div class="collapsible-content">
          <p style="font-size:16px;color:rgba(255,255,255,0.55);max-width:560px;margin:0 auto 32px;line-height:1.7">A single intelligent engine powers web chat, voice, phone, and SMS. The more your AI learns, the smarter every channel becomes.</p>
  ...
  <section class="section-dark">
    <div class="container">
      <div class="section-heading">
        <h2>Take the Driver&rsquo;s Seat</h2>
        <p>Your AI agent is ready &mdash; now make it yours.</p>
      </div>
      <div class="try-grid">
        <div class="try-card${tenantInfo.subdomain ? "" : " try-card-full"}" style="background: linear-gradient(135deg, rgba(79,70,229,0.08), rgba(200,246,74,0.06)); border-color: rgba(79,70,229,0.25);">
          <div class="try-card-icon" style="background: rgba(79,70,229,0.12);">
          ...
          <h3>Take Control of Your AI Agent</h3>
          <p>Create your admin account to access the dashboard, customize responses, manage training data, and monitor conversations.</p>
          <ol class="try-steps">
            <li>Click below and enter your email address</li>
            <li>Check your inbox for a sign-in link</li>
            <li>Complete your profile and verify your phone</li>
            <li>Access the dashboard to manage your AI assistant</li>
          </ol>
          ${
						inviteUrl
							? `<div class="try-links">
            <a href="${esc(inviteUrl)}" class="try-btn try-btn-primary" style="background: #4f46e5;">Create Admin Account &rarr;</a>
          </div>
          <div class="try-note">
            This invitation is valid for 2 weeks.
          </div>`
							: `<div class="try-note">
            An admin invitation link will be included when this demo is published.
          </div>`
					}
        </div>
        ${
          ...
          <p>Add the AI chat widget to your website with a single line of code. Just add this script tag to your HTML:</p>
          <pre class="try-code"><code>&lt;script src="https://${esc(tenantInfo.subdomain)}.xinfer.ai/widget.js" async&gt;&lt;/script&gt;</code></pre>
          <div class="try-links">
            <a href="https://${esc(tenantInfo.subdomain)}.xinfer.ai/widget-embed-howto" target="_blank" class="try-btn try-btn-outline">See How It Works &rarr;</a>
          </div>
        </div>`
						: ""
				}
